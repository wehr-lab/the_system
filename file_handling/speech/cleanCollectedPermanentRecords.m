function cleanCollectedPermanentRecords()

%Scratchy help b/c writing quickly JLS052516 - Because compiled records are an absolute clusterfuck we have to go back
%and rebuild our data from scratch if we actually want to use it. what a
%great piece of software this is.

%use this one when you have compiled all the recs in one folder
